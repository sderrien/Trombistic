...
public class ExcelModel {
  ...
  public static String buildPhotoName(final String string, final String string2) {
    String _removeAccent = ExcelModel.removeAccent(string);
    String _plus = (_removeAccent + "_");
    String _removeAccent_1 = ExcelModel.removeAccent(string2);
    String _plus_1 = (_plus + _removeAccent_1);
    return (_plus_1 + ".png").replace("\'", "-");
  }
}
